...
class _CreatePersonState extends State<CreatePerson> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Form. Crear Persona"),
      ),
                  ...
                  TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_validateCedula == false &&
                          ...
                          persona.enviado = 0;
                          var result =
                              await _personService.savePersona(persona);
